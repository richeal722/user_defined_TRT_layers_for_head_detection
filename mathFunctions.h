...
cudaError_t tensorrt_gpu_permute(const int nthreads, float *const bottom_data, const bool forward,
                                 ...
                                 const int num_axes, float *const top_data, cudaStream_t stream);

cudaError_t SoftmaxLayer(const float *bottom_data, int count, int channels, int outer_num_, int inner_num_, float *scale_data,
